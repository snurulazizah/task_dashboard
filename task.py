...
API_TOKEN = "91e13a8d9f28183051a6b40eb3763c2b73f28cefbacc46b2d2475a49680a7473"

if not API_TOKEN or API_TOKEN.strip() == "":
    st.error("❌ Token belum diisi. Masukkan token API Qontak CRM di bagian atas kode.")
    st.stop()
